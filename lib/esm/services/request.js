...
function getRequest(url, params, options) {
    ...
    return new classes_1.Request(url, Object.assign(Object.assign({}, options), { method: "GET" }));
}
...
function patchRequest(url, params, options) {
    return new classes_1.Request(url, prepareWriteOptions("PATCH", params, options));
}
...
function putRequest(url, params, options) {
    return new classes_1.Request(url, prepareWriteOptions("PUT", params, options));
}
...
function deleteRequest(url, options) {
    return new classes_1.Request(url, Object.assign(Object.assign({}, options), { method: "DELETE" }));
}
...
function optionsRequest(url, options) {
    return new classes_1.Request(url, Object.assign(Object.assign({}, options), { method: "OPTIONS" }));
}
...
function headRequest(url, options) {
    return new classes_1.Request(url, Object.assign(Object.assign({}, options), { method: "HEAD" }));
}
...
function postRequest(url, params, options) {
    return new classes_1.Request(url, prepareWriteOptions("POST", params, options));
}
 ...
 * @param options
 */
function createRequestsController(options) {
    return new classes_2.RequestsController(options);
}
 ...
 */
function createRequestsBucket(requests) {
    return new classes_3.Bucket(requests);
}
